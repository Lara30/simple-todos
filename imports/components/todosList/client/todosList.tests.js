...
//ajouter un test pour vérifier le nombre incomplet de tâches
import { assert } from 'meteor/practicalmeteor:chai';
import { sinon } from 'meteor/praticalmeteor:sinon';
...
describe('todosList', function() {
    ...
    //pour tester le contrôleur avec l'importe sinon :
    describe('controller', function() {
        describe('addTask', function() {
            ...
            it ('should reset nexTask', function() {
